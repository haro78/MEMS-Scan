...
#ifndef ABSTRACTMETER900_H
#define ABSTRACTMETER900_H
...
#include "widgetwithbackground.h"
   ...
   */
   class AbstractMeter900 : public WidgetWithBackground
   {
	Q_OBJECT
    ...
    public:
    	...
    	AbstractMeter900(QWidget *parent = 0);
	virtual ~AbstractMeter900() {};
