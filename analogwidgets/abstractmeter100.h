...
#ifndef ABSTRACTMETER100_H
#define ABSTRACTMETER100_H
...
#include "widgetwithbackground.h"
   ...
   */
   class AbstractMeter100 : public WidgetWithBackground
   {
	Q_OBJECT
    ...
    public:
    	...
    	AbstractMeter100(QWidget *parent = 0);
	virtual ~AbstractMeter100() {};
